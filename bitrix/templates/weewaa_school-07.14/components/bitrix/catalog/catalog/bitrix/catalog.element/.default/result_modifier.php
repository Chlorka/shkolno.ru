...
if(!isset($arResult["~DETAIL_PICTURE"]))
	$arResult["DETAIL_PICTURE"] = array_change_key_case(CFile::ResizeImageGet($arResult["MORE_PHOTO"][0]['ID'], array("width"=>400, "height"=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, true), CASE_UPPER);

if($arResult["DETAIL_PICTURE"]["WIDTH"]>400)
	$arResult["DETAIL_PICTURE_LARGE"] = array_change_key_case(CFile::ResizeImageGet($arResult["DETAIL_PICTURE"]['ID'], array("width"=>400, "height"=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, true), CASE_UPPER);
else 
	$arResult["DETAIL_PICTURE_LARGE"] = $arResult["DETAIL_PICTURE"];


$arResult["DETAIL_PICTURE_MINI"] = array_change_key_case(CFile::ResizeImageGet($arResult["DETAIL_PICTURE"]['ID'], array("width"=>70, "height"=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, true), CASE_UPPER);

// r($arResult);
foreach($arResult["MORE_PHOTO"] as $key=>$photo) {
	$arResult["MORE_PHOTO_MINI"][$key] = array_change_key_case(CFile::ResizeImageGet($photo['ID'], array("width"=>70, "height"=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, true), CASE_UPPER);
}
//r($arResult["MORE_PHOTO"]);
?>