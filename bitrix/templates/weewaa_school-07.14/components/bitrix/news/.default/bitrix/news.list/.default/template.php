...
<section class="pm-promo-list row">
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<article id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="col_3">
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<a class="pm-review-item" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a>
			<?else:?>
				<?echo $arItem["NAME"]?>
			<?endif;?>
		<?endif;?>
