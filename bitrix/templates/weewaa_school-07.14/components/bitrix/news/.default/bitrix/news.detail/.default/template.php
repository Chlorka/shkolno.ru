...
<div class="pm-promo-detail">
	...
	<?elseif($arParams["DISPLAY_PICTURE"]!="N" && is_array($arResult["DETAIL_PICTURE"])):?>
	...
	<p><a class="pm-link-back" href="<?=$arResult["LIST_PAGE_URL"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?> <?=ToLower($arResult["IBLOCK"]["NAME"])?></a></p>
</div>
