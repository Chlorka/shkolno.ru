...
<?}?>
			...
			<?endforeach;?>
			<tr>
				<td colspan="2" class="ww-all-dell"><a href="?del_all=Y" onclick="jsAjaxUtil.InsertDataToNode('?add=Y&ajax_call=Y',
'ww-bask', true); return false;">Добавить товар</a></td>
...
менеджеру компании относительно вашего заказа"></textarea>
                </td>
              <?elseif($r=='COUNT'):?>
