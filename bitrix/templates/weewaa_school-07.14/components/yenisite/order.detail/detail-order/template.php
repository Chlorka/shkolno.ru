...
<?}?>
			...
			<tr>
				...
				<td colspan="4" class="ww-all-sum"><span>Всего товаров <?=$cntitem;?> на сумму <?=$arResult["COMMON_PRICE"]?>р.</span></td>
			</tr>
		</table>
...
<p style="text-align: center;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="/account/orders/detail_user/?ORDER=<?=$_REQUEST['ORDER']?>&print=Y" class="ww-button"  target="_blank" >Печать для клиента</a>
	<?/*?>
